...
#buy_order = client.spot_place_order(symbol='btcusdt_spbl', price='31426.5', quantity='0.001', side='buy', orderType='limit',force="normal")
#sell_order = client.spot_place_order(symbol='btcusdt_spbl', price='29426.5', quantity='0.001', side='sell', orderType='limit',force="normal")
#print(buy_order)
#print(sell_order)
